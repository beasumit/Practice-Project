...
#page setup
about_page = st.Page(
    page = "Portfolio_streamlit\pages\about_me.py",
    title = "About Me",
    icon = "😁",
    default = True
)
...
sale_dashboard_page = st.Page(
    page = "Portfolio_streamlit\pages\sale_dashboard.py",
    title = "Sales Dashboard",
    icon = "💵"
)

chat_bot_page = st.Page(
    page = "Portfolio_streamlit\pages\chatbot.py",
    title = "Chat-Bot",
    icon = "🤖"
)
...
st.logo("Portfolio_streamlit\assets\logo.png")
